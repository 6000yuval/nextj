...
featuredImage: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&q=80&w=1000'
draft: false
...
<div className="space-y-4">
  <details className="group bg-slate-50 p-4 rounded-lg cursor-pointer">
    <summary className="font-bold text-slate-800 list-none flex justify-between items-center"><span>האם ללמוד תכנות זה בזבוז זמן?</span></summary>
  ...
  <details className="group bg-slate-50 p-4 rounded-lg cursor-pointer">
    <summary className="font-bold text-slate-800 list-none flex justify-between items-center"><span>מתי השינוי הזה יקרה?</span></summary>
    <p className="text-slate-600 mt-2 text-sm">
